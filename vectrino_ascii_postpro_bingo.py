...
data_directory = 'bingo-data/'
relevant_point_IDs = (14, 15, 16)
...
for ascii_file in unique_names:
    ...
    vectrino_data = apply_transformation(vectrino_data, transformation_matrix=M, relevant_point_ids=relevant_point_IDs)
    # write to CSV file
